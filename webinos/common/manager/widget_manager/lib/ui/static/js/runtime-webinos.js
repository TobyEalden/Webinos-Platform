// Check for webinos injected by runtime.
if (typeof webinos !== "undefined") {
  try { 
    // webinos already injected by runtime - has comms been established?
    if (typeof webinos.rpcHandler === "undefined") {
      // Create websocket channel
      webinos.createComms("8081"); 
    }
  } catch (e) { 
...
/*
  Paste webinos.js built by ant here.
  
  !!!! Remember to change createCommChannel to always use localhost:8080 (or fix to use webinos_runtime.json).  
*/
if(typeof webinos === "undefined") {
  webinos = {}
}
...
/*
  End webinos.js built by ant here.
*/
}
